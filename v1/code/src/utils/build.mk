...
SRCS += ../src/app/app_display.c
SRCS += ../src/app/nixie.c 
SRCS += ../src/app/nixie_menu.c 
...
SRCS += ../src/hardware/modules/bkp.c 
SRCS += ../src/hardware/modules/i2c.c 
SRCS += ../src/hardware/modules/gpio.c 
SRCS += ../src/hardware/modules/rtc.c 
SRCS += ../src/hardware/modules/uart.c 
SRCS += ../src/main.c 
